                                        ...
                                        <td class="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                            ...
                                            @else
                                                <div
                                                    ...
                                                    <h2 class="text-sm font-normal text-red-500">disabled</h2>
                                                </div>
                                            @endif
                                        </td>
                                        <td
                                            ...
                                            <span
                                                class="font-medium text-gray-800 dark:text-white">{{ $campaign->time_lapse }}</span>
                                            sec</td>
            ...
            <div class="flex items-center mt-6 text-center border rounded-lg h-96 dark:border-gray-700">
                <div class="flex flex-col w-full max-w-sm px-4 mx-auto">
                    ...
                    @if ($search !== '')
                        ...
                        @else
                            <p class="mt-2 text-gray-500 dark:text-gray-400">you have not created any campaign yet. start by clicking  create a campaign.</p>
                            <div class="flex items-center mt-4 sm:mx-auto gap-x-3">
                    @endif
                    <a href="{{ route('clients.index') }}">
